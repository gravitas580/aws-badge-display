...
const AWS_CERTIFICATIONS = [
    ...
    { code: 'SysOps', name: 'SysOps Administrator Associate', expectedFileName: 'aws-certified-sysops-administrator-associate.png' },
    ...
    { code: 'SAC', name: 'Advanced Networking Specialty', expectedFileName: 'aws-certified-advanced-networking-specialty.png' },
    { code: 'SCS', name: 'Security Specialty', expectedFileName: 'aws-certified-security-specialty.png' },
    { code: 'DEV', name: 'DevOps Engineer Professional', expectedFileName: 'aws-certified-devops-engineer-professional.png' },
];
